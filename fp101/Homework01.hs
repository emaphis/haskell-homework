...
revqsort' []     = []
revqsort' (x:xs) = revqsort' lrg ++ [x] ++ revqsort' sml
...
-- a and xs don't align, backquotes on div, 'm' should be lower cas

-- Ex (2)
-- 4. Show how the library function last that selects the last element of a nonempty
